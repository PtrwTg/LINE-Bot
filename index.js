...
      
    // *********************************
    // *** Case: เมนูข้อมูลส่วนตัว (Quick Reply Sub-Menu 1) (ปรับปรุงแล้ว) ***
    // *********************************
...
      
    // *********************************
    // *** Default Catch-All (ปรับปรุงแล้ว) ***
    // *********************************
    } else {
      // Default Catch-All: แสดงคำแนะนำการใช้งาน
      const mainMenu = {
        type: 'text',
        text: '🤖 **คู่มือการใช้งาน:**\n\nสามารถใช้งานบอทได้ 2 วิธีหลักๆ ครับ:\n\n1. **ใช้ Rich Menu** (เมนูหลักด้านล่างจอ) เพื่อเข้าสู่ **ข้อมูลส่วนตัว** (ประวัติ, ทักษะ, ผลงาน, ติดต่อ)\n\n2. **พิมพ์คำสั่ง** หรือใช้ Quick Reply เพื่อเข้าสู่ **เมนูงานรับปริญญา**\n\nคำสั่งที่ใช้ได้:\n- พิมพ์: **เมนูงานรับปริญญา**',
        quickReply: {
          items: [{
            type: 'action',
            action: {
              type: 'message',
              label: 'ข้อมูลส่วนตัว (Rich Menu)',
              text: 'ประวัติส่วนตัว' // ส่งคำสั่งตรงไปยังส่วนแรกของ Rich Menu เพื่อยืนยัน
            }
          }, {
            type: 'action',
            action: {
...
    // ข้อความต้อนรับเมื่อผู้ใช้กดติดตาม (ปรับปรุงแล้ว)
