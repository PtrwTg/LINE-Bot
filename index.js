...
const CONFIG = {
    ...
    IMAGE_TICKET_DEPARTURE: "https://i.postimg.cc/Dz1ryTvP/edit.jpg",
...
/** 2.10 ข้อมูลงาน: ตั๋วขาไป (รูปภาพ) */
const getDepartureTicket = () => ({
    type: 'image',
    originalContentUrl: CONFIG.IMAGE_TICKET_DEPARTURE,
    previewImageUrl: CONFIG.IMAGE_TICKET_DEPARTURE
});
