...
              }, {
                "type": "text",
                "text": "เลขบัญชี: 123-4-56789-0",
                "size": "sm",
                "color": "#333333"
              }, {
                "type": "text",
                "text": "ชื่อบัญชี: นายเสือ จบใหม่ (เผื่อใครโอน manual)",
                "size": "sm",
                "color": "#333333"
              }, {
                // *** เพิ่มรูป QR Code ของคุณที่นี่ ***
                "type": "image", 
                "url": "[URL_QR_CODE_PROMPT_PAY_OR_BANK]", 
                "size": "full",
                "aspectRatio": "1:1",
                "aspectMode": "fit",
                "margin": "lg"
...
        // Quick Reply Sub-Menu สำหรับตั๋วเครื่องบิน (แก้ไข Label สั้นแล้ว)
        const ticketOptions = {
            type: 'text',
...
            }
          }, {
            // ลำดับที่ 2: สนับสนุน (ใหม่)
            type: 'action',
            action: {
              type: 'message',
              label: 'สนับสนุน 💰', // Label ที่แสดงบนปุ่ม
              text: 'สนับสนุน' // Trigger คำสั่งใหม่
            }
          }, {
            // ลำดับที่ 3: อวยพร
            type: 'action',
...
              type: 'message',
              label: 'ข้อมูลส่วนตัว',
              text: 'เมนูข้อมูลส่วนตัว' // คำสั่งใหม่สำหรับเมนูย่อย 1
            }
          }, {
            type: 'action',
            action: {
              type: 'message',
              label: 'งานรับปริญญา',
              text: 'เมนูงานรับปริญญา' // คำสั่งใหม่สำหรับเมนูย่อย 2
            }
          }]
        }
      };
