...
    
    // *********************************
    // *** Case: กำหนดการ (อัปเดต: เพิ่มรูปภาพ) ***
    // *********************************
    } else if (userMessage === 'กำหนดการ') {
      // 1. ส่งรูปภาพกำหนดการก่อน (ใช้รูปที่แนบมา S__34897939_0.jpg)
      const scheduleImage = {
        type: 'image',
...
      return client.replyMessage(event.replyToken, [scheduleImage, scheduleFlexMessage]);
    
    // *********************************
    // *** Case: ลงทะเบียน ***
    // *********************************
...
        type: 'text',
        text: '👤 **ข้อมูลส่วนตัว**\n\nสำหรับข้อมูลส่วนตัว เช่น ประวัติ ทักษะ ผลงาน และช่องทางการติดต่อ ท่านสามารถเข้าถึงได้สะดวกที่สุดผ่าน **Rich Menu (เมนูหลัก)** ด้านล่างจอเลยครับ!',
      });

    // *********************************
    // *** Case: เมนูงานรับปริญญา (Quick Reply Sub-Menu 2 - พร้อมคำอธิบาย) ***
    // *********************************
    } else if (userMessage === 'เมนูงานรับปริญญา') {
      // เมนูย่อย 2: เมนู Quick Reply สำหรับงานรับปริญญา พร้อมคำอธิบาย
      const graduationMenu = {
        type: 'text',
        text: "🎓 **ข้อมูลงานรับปริญญา:**\n\n" +
              "🗓️ **กำหนดการ** : ดูตารางเวลาในการทำกิจกรรมต่างๆ ทั้งวันซ้อมและวันรับจริง\n" +
              "📝 **ลงทะเบียน** : ใช้สำหรับบันทึกว่าสนใจเข้าร่วมงาน พร้อมเบอร์ติดต่อ\n" +
              "💰 **สนับสนุน** : ผู้ใดสนใจมอบค่าขนมเพื่อใช้เป็นค่าใช้จ่ายเชิญทางนี้\n" +
              "💌 **อวยพร** : ทุกคนสามารถอวยพรเพื่อมอบกำลังใจให้กับผมได้ที่นี่ครับ\n" +
              "🏨 **ที่พัก** : ตำแหน่งที่พักของครอบครัวของผมสำหรับวันจริง\n" +
              "✈️ **ตั๋วเครื่องบิน** : รายละเอียดตั๋วเครื่องบินสำหรับครอบครัวของผมสำหรับวันจริง\n\n" +
              "กดเลือกเมนูที่ท่านต้องการได้เลยครับ:",
        quickReply: {
          items: [{
            type: 'action',
            action: {
...
      
    // *********************************
    // *** Default Catch-All (สั้นกระชับ) ***
    // *********************************
    } else {
      // Default Catch-All: แสดงคำแนะนำการใช้งานที่สั้นลงพร้อม Quick Reply 2 เมนูหลัก
      const defaultMenu = {
        type: 'text',
        text: '🤖 ไม่เข้าใจคำสั่งครับ กรุณาเลือกหัวข้อหลักที่ต้องการจาก Quick Reply ด้านล่างนี้ หรือใช้ Rich Menu (เมนูภาพด้านล่างจอ) ได้เลยครับ:',
        quickReply: {
          items: [{
            type: 'action',
            action: {
              type: 'message',
              label: 'ข้อมูลส่วนตัว',
              text: 'ประวัติส่วนตัว' // นำไปสู่การทำงานของ Rich Menu Area 1
            }
          }, {
            type: 'action',
            action: {
              type: 'message',
              label: 'งานรับปริญญา',
              text: 'เมนูงานรับปริญญา' // นำไปสู่เมนู Quick Reply ย่อยงานรับปริญญา
            }
          }]
        }
      };
      return client.replyMessage(event.replyToken, defaultMenu);
    }
...
          }, {
            "type": "text",
            "text": "บอทนี้ถูกออกแบบมาเพื่อให้ข้อมูล 2 ส่วนหลักๆ คือ **ข้อมูลส่วนตัว** (Resume) และ **ข้อมูลงานรับปริญญา** (3 ต.ค. และ 7 ต.ค.)",
            "size": "sm",
            "color": "#666666",
            "wrap": true,
            "margin": "md"
...
          }, {
            "type": "text",
            "text": "👉 **เมนูหลัก (Rich Menu)** ด้านล่างจอคือ **ข้อมูลส่วนตัว** ครับ (ประวัติ, ทักษะ, ผลงาน, ติดต่อ)",
            "size": "sm",
            "color": "#00563b",
            "wrap": true,
            "margin": "lg",
...
          }, {
            "type": "text",
            "text": "👉 หากต้องการดู **ข้อมูลงานรับปริญญา** กรุณาพิมพ์คำว่า **'เมนูงานรับปริญญา'** หรือใช้ปุ่ม Quick Reply ที่ปรากฏขึ้นมาได้เลยครับ!",
            "size": "sm",
            "color": "#666666",
            "wrap": true,
            "margin": "sm"
