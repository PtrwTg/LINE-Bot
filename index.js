...
    // 🆕 NEW: URL ตั๋วขาไป 2 ใบ (ใช้ Raw URL จาก GitHub)
    // ⚠️⚠️⚠️ เปลี่ยน YOUR_GITHUB_USER และ YOUR_REPO_NAME เป็นชื่อบัญชี GitHub และชื่อโปรเจกต์ของคุณ ⚠️⚠️⚠️
    IMAGE_TICKET_DEPARTURE_THAWORN: "https://raw.githubusercontent.com/PtrwTg/LINE-Bot/blob/main/Thaworn_toDMK.jpg",
    IMAGE_TICKET_DEPARTURE_YUWADA: "https://raw.githubusercontent.com/PtrwTg/LINE-Bot/blob/main/Yuwada_toDMK.jpg",
    
...
/** 2.10 ข้อมูลงาน: ตั๋วขาไป (Flex Carousel สำหรับ 2 ตั๋ว) */
const getDepartureTicket = () => ({
    type: 'flex',
    altText: 'ตั๋วเครื่องบินขาไป (Air Asia FD3189)',
    contents: {
        "type": "carousel",
        "contents": [
            // Bubble 1: ตั๋วของคุณทวร
            {
                "type": "bubble",
                "header": {
                    "type": "box", "layout": "vertical",
                    "contents": [
                        { "type": "text", "text": "ตั๋วขาไป (คุณทวร)", "weight": "bold", "size": "xl" },
                        { "type": "text", "text": "FD 3189 | NST → DMK | 06 ต.ค. 08:35 น.", "size": "sm", "color": "#AAAAAA" }
                    ]
                },
                "body": {
                    "type": "box", "layout": "vertical",
                    "contents": [
                        { "type": "image", "url": CONFIG.IMAGE_TICKET_DEPARTURE_THAWORN, "size": "full", "aspectMode": "cover", "aspectRatio": "3:4" }
                    ]
                },
                "footer": {
                    "type": "box", "layout": "vertical",
                    "contents": [
                        { "type": "text", "text": "ที่นั่ง: 19F | เกทชั่วคราว: 3", "size": "xs", "color": "#666666" },
                        { "type": "text", "text": "⚠️ กรุณาตรวจสอบเกทจากจอสนามบิน", "size": "xs", "color": "#FF0000" }
                    ]
                }
            },
            // Bubble 2: ตั๋วของคุณยุวดี
            {
                "type": "bubble",
                "header": {
                    "type": "box", "layout": "vertical",
                    "contents": [
                        { "type": "text", "text": "ตั๋วขาไป (คุณยุวดี)", "weight": "bold", "size": "xl" },
                        { "type": "text", "text": "FD 3189 | NST → DMK | 06 ต.ค. 08:35 น.", "size": "sm", "color": "#AAAAAA" }
                    ]
                },
                "body": {
                    "type": "box", "layout": "vertical",
                    "contents": [
                        { "type": "image", "url": CONFIG.IMAGE_TICKET_DEPARTURE_YUWADA, "size": "full", "aspectMode": "cover", "aspectRatio": "3:4" }
                    ]
                },
                "footer": {
                    "type": "box", "layout": "vertical",
                    "contents": [
                        { "type": "text", "text": "ที่นั่ง: 19E | เกทชั่วคราว: 3", "size": "xs", "color": "#666666" },
                        { "type": "text", "text": "⚠️ กรุณาตรวจสอบเกทจากจอสนามบิน", "size": "xs", "color": "#FF0000" }
                    ]
                }
            }
...
    'ตั๋วขาไป': getDepartureTicket, // ใช้งาน Flex Carousel ตัวใหม่
