...
      const defaultMenu = {
        type: 'text',
        text: '🤖กรุณาเลือกหัวข้อหลักที่ต้องการจาก Quick Reply ด้านล่างนี้ หรือใช้ Rich Menu (เมนูภาพด้านล่างจอ) ได้เลยครับ:',
        quickReply: {
          items: [{
            type: 'action',
            action: {
...
    // *********************************
    // *** ส่วนนี้ถูกลบแล้ว - ให้ใช้ Greeting Message ใน LINE OA Manager แทน ***
    // *********************************
    // ลบโค้ด Flex Message ต้อนรับเดิมออกไป
    return Promise.resolve(null); // ไม่ต้องตอบกลับใดๆ เมื่อเกิด Follow Event
  }
